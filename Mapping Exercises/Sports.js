   var sports = [
        ...
        },
        {
          ...
          strSport: "Fighting",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/fighting.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Baseball",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/baseball.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Basketball",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/basketball.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/american_football.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Cricket",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/cricket.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Cycling",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/cycling.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/australian_football.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "ESports",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/esports.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Volleyball",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/volleyball.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Netball",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/netball.jpg",
          strSportDescription:
        ...
        },
        {
          ...
          strSport: "Handball",
          strSportThumb:
            "https://www.thesportsdb.com/images/sports/handball.jpg",
          strSportDescription:
      ...
      var getNewSports = function (sportsAr) {
        //console.log("Working");
        var mapAllSports = sportsAr.map(mapSports);
        function mapSports(sports) {
          var mySports = {
            id: Number(sports.idSport), //this needs to be an integer and not a string
            name: sports.strSport,
            thumbName: sports.strSportThumb,
            shortDescription: sports.strSportDescription.slice(0, 50),
            description: sports.strSportDescription,
          };
          return mySports;
        }
      ...
      var getBallSports = function (sportsAr) {
        var filterBallSports = sportsAr.filter((obj) => {
          if (obj.name === "Baseball" || obj.name === "Soccer") {
            return true;
          }
        });
        return filterBallSports;

        // var filterBallSports = sportsAr.filter(filterSports);

        // function filterSports(obj) {
        //   result = false;

        //   if (obj.name === "Baseball" || "Soccer") {
        //     result = true;
        //   }
        //   return result;
        // }
      ...
      var MyFavoriteSports = getBallSports(mappedSports);
